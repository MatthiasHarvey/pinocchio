# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-03-26 09:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='peer_review.Question')),
                ('questionnaire', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='peer_review.Questionnaire')),
                ('questionGrouping', models.ForeignKey(default=4, on_delete=django.db.models.deletion.CASCADE, to='peer_review.QuestionGrouping')),
            ],
        ),
        migrations.AddField(
